...
public abstract class PlaywrightWrapper extends Reporter{
	...
	public boolean uploadFile(String locator, String value, String name) {
		try {
			getPage().locator(locator).setInputFiles(Paths.get(value));
	...
	public boolean clickAndChooseInFrame(String ddLocator, String optionLocator, String name, String option) {
		try {
